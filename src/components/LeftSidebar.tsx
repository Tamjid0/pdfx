...
const LeftSidebar: React.FC = () => {
    ...
    return (
        <aside className="sidebar-left w-[320px] bg-[#111] border-r border-[#222] flex flex-col h-full overflow-hidden">
            <div className="left-sidebar-tabs flex-shrink-0 flex bg-[#1a1a1a] border-b border-[#333]">
                <button
            ...
            <div className="left-tab-content flex-grow overflow-y-auto p-5">
                {activeTab === "stats" && (
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="stats-card bg-[#1a1a1a] border border-[#333] rounded-xl p-4">
                            <div className="stats-title text-xs font-semibold text-[#00ff88] uppercase tracking-wider mb-4">
                                Content Stats
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="stat-box text-center p-3 bg-[rgba(0,255,136,0.05)] rounded-lg">
                                    <span className="stat-value text-2xl font-bold text-[#00ff88] block mb-1">
                                        {stats.wordCount}
                                    </span>
                                    <span className="stat-label text-xs text-[#999] uppercase">
                                        Words
                                    </span>
                                </div>
                                <div className="stat-box text-center p-3 bg-[rgba(0,255,136,0.05)] rounded-lg">
                        ...
                        <div className="basic-tools-card bg-[#1a1a1a] border border-[#333] rounded-xl p-4">
                            <div className="basic-tools-title text-xs font-semibold text-[#00ff88] uppercase tracking-wider mb-4">Quick Tools</div>
                            <div className="grid grid-cols-2 gap-2.5">
                                <div className="tool-btn flex flex-col items-center justify-center p-3 bg-[#252525] border border-[#333] rounded-lg cursor-pointer transition-all text-[#ccc] text-xs text-center hover:bg-[rgba(0,255,136,0.1)] hover:border-[#00ff88] hover:text-white">
                                    <svg className="w-6 h-6 mb-1.5 fill-[#999]" viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" /></svg>
                                    Search
                                </div>
                                <div className="tool-btn flex flex-col items-center justify-center p-3 bg-[#252525] border border-[#333] rounded-lg cursor-pointer transition-all text-[#ccc] text-xs text-center hover:bg-[rgba(0,255,136,0.1)] hover:border-[#00ff88] hover:text-white">
                                    <svg className="w-6 h-6 mb-1.5 fill-[#999]" viewBox="0 0 24 24"><path d="M15 21H9v-6H3v-2.83l14-14 2.83 2.83-14 14V18h5.17z" /></svg>
                                    Highlight
                                </div>
                                <div className="tool-btn flex flex-col items-center justify-center p-3 bg-[#252525] border border-[#333] rounded-lg cursor-pointer transition-all text-[#ccc] text-xs text-center hover:bg-[rgba(0,255,136,0.1)] hover:border-[#00ff88] hover:text-white">
                                    <svg className="w-6 h-6 mb-1.5 fill-[#999]" viewBox="0 0 24 24"><path d="M4 13h5v-2H4v2zm7 0h10v-2H11v2zm-7 5h7v-2H4v2zm9 0h8v-2h-8v2zM4 9h10V7H4v2zm11 0h5V7h-5v2z" /></svg>
                                    Outline
                                </div>
                                <div className="tool-btn flex flex-col items-center justify-center p-3 bg-[#252525] border border-[#333] rounded-lg cursor-pointer transition-all text-[#ccc] text-xs text-center hover:bg-[rgba(0,255,136,0.1)] hover:border-[#00ff88] hover:text-white">
                                    <svg className="w-6 h-6 mb-1.5 fill-[#999]" viewBox="0 0 24 24"><path d="M3 18h12v-2H3v2zM3 6v2h18V6H3zm0 7h18v-2H3v2z" /></svg>
                                    Notes
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col flex-grow h-full">
                        ...
                        <div className="templates-list flex-grow  pt-0 flex flex-col gap-3 overflow-y-auto">
                            {filteredTemplates.length > 0 ? (
                                filteredTemplates.map((template) => (
                                    ...
                                    >
                                        <div className="template-icon w-8 h-8 min-w-[32px] bg-[rgba(0,255,136,0.1)] rounded-md flex items-center justify-center">
                                            <svg
                                                viewBox="0 0 24 24"
                                        ...
                                        <div className="template-info flex-1">
                                            ...
                                            <div className="template-desc text-xs text-[#999] leading-snug">
                        ...
                        <div className="custom-prompt flex-shrink-0 pt-0">
                            <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4">
                                <h4 className="text-xs font-semibold text-[#00ff88] uppercase tracking-wider mb-3">Custom Instructions</h4>
                                <textarea
