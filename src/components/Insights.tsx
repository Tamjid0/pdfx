        ...
        <div className="flex flex-col h-full w-full bg-[#0a0a0a] rounded-xl border border-[#222] overflow-hidden shadow-2xl relative">
            <div className="flex items-center justify-between px-5 py-3 border-b border-[#222] bg-[#111] relative z-20">
                <div className="flex items-center gap-3">
                    <div className={`w-2 h-2 ${hasData ? 'bg-[#00ff88] shadow-[0_0_8px_rgba(0,255,136,1)]' : 'bg-gray-600'} rounded-full`}></div>
                    <h3 className="text-xs font-black text-white uppercase tracking-[0.3em]">{hasData ? 'Neural Extraction' : 'System Ready'}</h3>
                </div>
                ...
                <div className="flex gap-2 relative text-left">
                    <div className="relative">
                        ...
                        >
                            ...
                            {isGeneratingInsights ? 'EXTRACTING...' : (hasData ? 'REGENERATE' : 'SETUP')}
                        </button>
