                        ...
                        <div className="p-10 max-w-2xl mx-auto w-full space-y-12">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <button
                                        onClick={() => {
                                            if (window.confirm('Are you sure you want to regenerate? This will overwrite your current quiz.')) {
                                                onGenerate('quiz');
                                            }
                                        }}
                                ...
                                {quizData.quiz.map((q, qIdx) => (
                                    <div key={qIdx} className="space-y-6 p-8 bg-white/[0.02] border border-white/5 rounded-3xl hover:border-white/10 transition-all">
                                        <div className="flex items-start gap-4">
                                            <div className="w-8 h-8 rounded-xl bg-white/5 flex items-center justify-center text-[9px] font-black text-gray-500 border border-white/10 shrink-0">{qIdx + 1}</div>
                                            <h2 className="text-base font-bold text-white leading-snug pt-1">{q.question}</h2>
                                        </div>
                                        ...
                                        <div className="pl-16 flex gap-4">
                                            {q.hint && (
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-[#00ff88]/5 border border-[#00ff88]/20 rounded-xl text-[10px] font-bold text-[#00ff88] hover:bg-[#00ff88]/10 transition-all flex items-center gap-2"
                                                >
                                            ...
                                            <button
                                                onClick={() => openEmbeddedChat(`quiz_${qIdx}`, 'quiz', q)}
                                                className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold text-gray-400 hover:text-white hover:bg-white/10 transition-all flex items-center gap-2"
                                            >
                                        ...
                                        {q.hint && (
                                            <div className="ml-16 p-4 bg-white/[0.01] rounded-2xl border border-dashed border-white/5">
                                                <p className="text-[11px] italic text-gray-500 leading-relaxed font-medium">"{q.hint}"</p>
                                            </div>
                                        )}
                                    </div>
                                ))}
                        ...
                        <div className="max-w-2xl mx-auto w-full flex-1 flex flex-col justify-center">
                            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                                <div className="space-y-4">
                                    ...
                                    {/* Hide AI/Hint during active exam */}
                                    {!isExamMode && (
                        ...
                        <div className="max-w-4xl mx-auto space-y-16">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="md:col-span-2 space-y-6">
                                    <h1 className="text-3xl md:text-5xl font-black text-white leading-none tracking-tighter uppercase whitespace-nowrap">
                                        Assessment <br /><span className="text-[#00ff88]">Analytics</span>
                                    </h1>
                                    <p className="text-gray-500 text-[13px] leading-relaxed max-w-sm">
                                        Your audit cycle is complete. Mastery of this document is currently rated at <span className="text-white font-medium">{accuracy}%</span>.
                                    </p>
                                </div>
                                <div className="flex flex-col items-center justify-center bg-white/[0.02] p-8 rounded-[3rem] border border-white/5">
                                    ...
                                    <div className="text-[9px] font-black tracking-[0.4em] text-gray-500 uppercase">Proficiency</div>
                                </div>
                            </div>
                                            ...
                                            <div key={i} className={`p-6 rounded-3xl border transition-all ${isCorrect ? 'bg-white/[0.01] border-white/5 opacity-50' : 'bg-red-500/5 border-red-500/20'}`}>
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    <div className="space-y-3 flex-1">
                                                        <div className="text-[13px] font-medium text-white/90">{q.question}</div>
                                                        <div className="flex flex-wrap items-center gap-3">
                                                            {!isCorrect && (
                                                                <div className="flex gap-3 items-center">
                                                                    <div className="text-[9px] uppercase font-black tracking-widest text-[#00ff88]">Correct: {String(q.correctAnswer)}</div>
                                                                    <div className="text-[9px] uppercase font-black tracking-widest text-red-500">Yours: {String(userAnswer || 'Skipped')}</div>
                                                                </div>
                                                            )}
                                                            <div className="flex gap-2">
                                                                {q.hint && (
                                                                    <button
                                                                        onClick={() => handleShowHint(q)}
                                                                        className="px-3 py-1.5 bg-[#00ff88]/5 border border-[#00ff88]/20 rounded-lg text-[9px] font-black text-[#00ff88] hover:bg-[#00ff88]/10 transition-all"
                                                                    >
                                                                        HINT
                                                                    </button>
                                                                )}
                                                                <button
                                                                    onClick={() => openEmbeddedChat(`quiz_${i}`, 'quiz', q)}
                                                                    className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-[9px] font-black text-gray-500 hover:text-white transition-all"
                                                                >
                                                                    EXPLAIN
                                                                </button>
                                                            </div>
